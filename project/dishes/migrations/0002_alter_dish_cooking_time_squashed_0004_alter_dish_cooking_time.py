...
class Migration(migrations.Migration):
    replaces = [
        ('dishes', '0002_alter_dish_cooking_time'),
        ('dishes', '0003_alter_dish_cooking_time'),
        ('dishes', '0004_alter_dish_cooking_time'),
    ]
    ...
    operations = [
        migrations.AlterField(
            ...
            field=models.DurationField(
                help_text='Время готовки в часах', verbose_name='время готовки'
            ),
        ),
        migrations.AlterField(
            model_name='dish',
